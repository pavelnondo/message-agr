-- Message Aggregator Database Setup Script for n8n Workflow
...
-- This table stores the AI configuration including system messages and FAQs.
...
-- 2. chats Table (Updated for n8n workflow)
-- This table tracks chat sessions and their states.
...
-- 3. messages Table (Updated for n8n workflow)
...
-- Initial Data Setup for bot_settings
-- Populate the bot_settings table with default values that match the n8n workflow
